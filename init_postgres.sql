...
VALUES
(1, 'Alex Johnson',   CURRENT_DATE - INTERVAL '13 months'),
(2, 'Maria Garcia',   CURRENT_DATE - INTERVAL '3 months'),
(3, 'Chen Wei',       CURRENT_DATE - INTERVAL '11 months'),
(4, 'Fatima Khan',    CURRENT_DATE - INTERVAL '18 months'),
(5, 'Luca Rossi',     CURRENT_DATE - INTERVAL '9 months'),
(6, 'Sofia Martinez', CURRENT_DATE - INTERVAL '12 months'),
(7, 'Noah Williams',  CURRENT_DATE - INTERVAL '1 month'),
(8, 'Amina Diallo',   CURRENT_DATE - INTERVAL '15 months'),
(9, 'Hiro Tanaka',    CURRENT_DATE - INTERVAL '10 months'),
(10,'Emma Brown',     CURRENT_DATE - INTERVAL '20 months')
